...
HD_PWD='D:/CLP/tp_final/sintesis/TP_Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log phase_accum_VIO_ILA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source phase_accum_VIO_ILA.tcl -notrace

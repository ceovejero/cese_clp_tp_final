...
HD_PWD='D:/CLP/tp_final/sintesis/TP_Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log phase_accum_VIO_ILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source phase_accum_VIO_ILA.tcl
